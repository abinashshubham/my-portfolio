...
const About = () => {
  ...
  const skillBars = [
    { name: "React.js & Frontend Logic", level: "90%" },
    { name: "Tailwind CSS & Bootstrap UI", level: "95%" },
    { name: "JavaScript (ES6+) Core", level: "88%" },
    { name: "Node.js / Express Backend", level: "85%" },
    { name: "MongoDB Database Management", level: "82%" },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-7 space-y-8">
          <p className="text-gray-400 leading-relaxed text-base sm:text-lg font-normal">
            I specialize in building modular frontend architectures, translating
            complex project blueprints into high-performance, pixel-perfect user
            interfaces. Just like structural design, I value precision, strong
            responsive layouts, and reliable performance across all modern
            viewports.
          </p>
          ...
          <div className="space-y-5">
            {skillBars.map((skill) => (
              <div key={skill.name} className="space-y-2">
                ...
                {/* Visual Progress Channel Bar Layer */}
